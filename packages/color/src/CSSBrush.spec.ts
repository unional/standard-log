...
test('background', t => {
  ...
  t.deepEqual(actual, [
    ...
    ['%c 3 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #0019ff;border: 1px solid #0000df;color: #ffffff;'],
    ['%c 4 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #0098ff;border: 1px solid #0078df;color: #ff6700;'],
    ['%c 5 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #2cff96;border: 1px solid #0cdf76;color: #d30069;'],
    ['%c 6 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #97ff00;border: 1px solid #77df00;color: #6800ff;'],
    ['%c 7 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #ffea00;border: 1px solid #dfca00;color: #0015ff;'],
    ['%c 8 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #ffea00;border: 1px solid #dfca00;color: #0015ff;'],
    ['%c 9 ', 'padding: 2px; margin: 2px; line-height: 1.8em;background: #ff6f00;border: 1px solid #df4f00;color: #0090ff;'],
