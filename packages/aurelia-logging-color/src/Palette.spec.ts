...
test('set colorMode', t => {
  const p = new Palette()
  // Running in node defaults to 'ANSI'
  t.is(p.colorMode, 'ANSI')
  t.is(p.color('x'), '\u001b[48;2;150;0;90mx\u001b[49m')
  p.colorMode = 'NONE'
  t.is(p.color('x'), 'x')
})
